...
<figure style="width: 50%; float: left; margin: 0 15px 15px 0;">
  ...
  <figcaption style="text-align: center;">Figure 1: A cartoon to illustrate an evolving filamentary network</figcaption>
</figure>
...
<figure style="width: 50%; float: left; margin: 0 15px 15px 0;">
  ...
  <figcaption style="text-align: center;">Figure : Median radial profiles for Gas density (first row), Dark matter density (second row), neutral fraction (third row),
...
different densities, with lower density parts indicated by more transparent lines. </figcaption>
</figure>
